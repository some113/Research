...
//                System.out.println("Mining sequences from: " + seqFile.getAbsolutePath());
                    try {
                        ...
                        while (!patterns.isEmpty()) {
                            ...
                            if (patterns.size() < k) writer.write(pattern.getPrefix() + " #SUP: " + pattern.support + "\n");
                            cnt++;
                        }
                    } catch (Exception e) {
...
//        try {
//            for (PatternTKS event : eventSet) {
//                writer.write(event.getPrefix() + " #SUP: " + event.support + "\n");
////                System.out.println(event);
//            }
//            writer.flush();
//            writer.close();
//        } catch (IOException e) {
//            System.out.println("Error when writing events: " + e.getMessage());
//            e.printStackTrace();
//        }
    }
